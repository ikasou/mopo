...
params.update({
    ...
    'exp_name': 'halfcheetah_medium_first_half_plus_unlabeled_COMBO',

})
params['kwargs'].update({
    'pool_load_path': '/home/ikasou/.d4rl/datasets/halfcheetah_medium_first_half_plus_unlabeled_to_min.hdf5',
